...
public class PushPadSpawn : NetworkComponent
{
    ...
    [SerializeField] public GameObject objectToSpawn; // Prefab to spawn
    [SerializeField] public Transform spawnPoint; // Location to spawn the object
